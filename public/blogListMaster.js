    ...
    blogListArr:[
        ...
        },
        {
            ...
            blogParagraphs: [
                {
                    paraId: 1,
                    paraText: "<h4>Sagrada Familia:</h4> Antoni Gaudi’s one of the very famous but incomplete work, Sagrada Familia is an unfinished Catholic Church but and hardly appears like any other church you’ll have seen in your life. Stained Glass windows, tall columns supporting high ornated ceilings and Gaudi’s signature artistic style dominates this signature building."
                },
                {
                    paraId: 2,
                    paraText: "<br /><h4>Park Güell:</h4> Another of Gaudi’s proclaimed creations, not like any usual park, with trees and shrubs you would also find twisted wrought iron gazebo, artistic colonnades, distinctive archways and other mosaic sculptures. You may also notice that hundreds of tourists are flocking around the central stairs leading to the terrace, mostly with their cameras and mobile phones! They are queuing up to get a selfie with the famous giant ceramic dragon."
                },
                {
                    paraId: 3,
                    paraText: "As beautiful as the entrance, the beautiful mosaic terrace dominates the park. With artfully curved fence and corrugated bench decorated with colourful mosaic work, it offers panoramic view of the city. You can also visit Gaudi’s House-Museum, where he lived from 1906 to 1926. It still holds the original furniture and decorative items as designed by the architect himself. <br /><br /><em>Tickets: Individual tickets are available from €10 and guided tours from €22. Find the latest ticket information <a href='https://parkguell.barcelona/ca/compra-entrades' target='_blank'>here</a>.</em>"
                },
                
                {
                    paraId: 4,
                    paraText: "<br /><h4>Casa Milà :</h4> Looks like a quarry from outside, Casa Mila also locally known as ‘La Padrera’ or ‘the stone quarry’ for its external appearance.	Located on 92, Passeig de Gràcia, it was built between 1906 and 1912 and was home to the Mila family who lived on the main floor and rented the rest. The building still holds some residential apartments today but is open to public for visits during day and night. <br /><br /><em>Tickets: Are sold in three categories, essential, Premium and the Night experience and are costed at €24, €31 and €34 respectively. Yes, I know what you must be thinking, is it expensive! Here is link to the official site for the latest information.</em>"
                },
                {
                    paraId: 5,
                    paraText: "<br /><h4>Casa Batlló:</h4> 500m from Casa Mila, if you walk towards the Passeig de Gràcia underground station, at number 43, you will find the next famous Gaudi creation, the Casa Batlló. Famous for the Skull and Bones balconies (Windows and balconies as skull and supporting poles as bones, it is one of the iconic creations. It is a UNESCO World Heritage site and attracts more than 1M visitor every year.  So, I would recommend visit it early around 9am, to avoid crowds to enjoy this magnificent beauty in peace. And, don’t just walk by, go inside to know its true worth. You will be left gobsmacked! <br /><br /><em>Ticket: Tickets vary so reach out the official website to find the latest details.</em>"
                },
                {
                    paraId: 6,
                    paraText: "<br /><h4>Gothic Quarter:</h4> A very interesting neighbourhood and full of history and period charm, Gothic Quarter is certainly one of the most talked about attractions of Barcelona. Narrow medieval streets with hidden squares at almost every corner, trendy Catalan restaurants and bars, boutique shops selling art and craft items and local bakeries are few of the highlights of this 2000 years old part of the city. A true authentic Catalan experience, don’t miss out on the Gothic Quarter."
                },
                {
                    paraId: 7,
                    paraText: "<br /><h4>Montjuic Castle:</h4> It is an old military fortress dating back from 1640 on the Montjuic mountain. Located around 173m above the sea level, it provided the strategic location for a defensive site in the past and today offers the best views of the city. Don’t miss out the parade ground, the terrace and the watch towers. The 155m long sea facing wall provides the best views of the port of Barcelona and the Balearic sea. <br /><br /><em>How to get there: Take metro line 3 to Parallel and then change to the Cable Car (included in the metro ticket) up to Montjuic. Cable car journey to me was the best part of this trip. Note that there are three stops, Parc de Montjuic, Mirador and the Castell de Monjuic on this route. </em> <br /> <br /> <em>Ticket: Tickets vary for adults and children. Find the latest ticket information here. \nTIPS: Sunday after 3PM you can enter the attraction completely free of charge.From the cable car facilities, you can very easily walk to the Olympic stadium (1992 Olympics were held here)</em>"
                },
                {
                    paraId: 8,
        ...
        
        {
            ...
            blogYTImageLib:[
                {   
                    ...
                    YTLinks:{
                        YTLink: "https://www.youtube.com/embed/qObSFfdfe7I",
                        YTImgURL: "/images/category/europe/blogs/barcelona/sagrada/content/ytImgURL.jpg"
                    }
                }
            ],
            blogParagraphs: [
                {
                    paraId: 1,
                    paraText: "Barcelona, one of the famous capitals in the world is also known by the famous architect Antoni Gaudi. Gaudi was born in Reus in 1852 and had studied architecture. His work was different from his contemporaries and mostly inspired by nature. He was regarded as Catalan modernist for his own unique personality and style. He used natural colours and patterns for his designs and material like stained glass, ceramics, wrought iron. He even introduced a technique called trencadis, which used waste ceramic pieces."
                },
                {
                    paraId: 2,
                    paraText: "<br /><h4>Basílica de la Sagrada Família:</h4>If you look out for ‘Top Things to do in Barcelona’, I bet you most of the top spots would be one or the other Gaudi’s creation. This Spanish architect’s name is synonymous to this city as tapas is to Spain! Let’s start the tour from the famous Sagrada Familia, also locally known as the Basílica de la Sagrada Família. An unfinished Roman Catholic basilica, standing tall in the centre of the city. For its importance in history and to preserve the famous Catalan art, Gaudi’s work on this building is part of UNESCO World Heritage Site."
                },
                {
                    paraId: 3,
                    paraText: "<br /><h4>History:</h4> Initial project was designed by Francisco de Paula del Villar, in 1882. But his architecture was replaced soon in 1883 by Antoni Gaudi, who was working on other projects at that time. Thereafter, until his death in 1926, Gaudi worked exclusively on Sagrada Familia but could only see the Bell Tower completed. Since then five generations have seen it being constructed and the construction is finally expected to be completed in 2026…I can’t wait to be back to admire the beauty in its entirety."
                },
                {
                    paraId: 4,
                    paraText: "<br /><h4>Tickets:</h4> Sagrada Familia is one of the most popular tourist spots in Barcelona and therefore is ALWAYS busy. There are only limited entry slots during the day, so please try and book your tickets in advance (to avoid disappointment). Tickets could be booked online, use the link to check official availability. I would recommend if you aren’t constraint on a budget, take a guided tour. Otherwise, you may miss a lot of the intricate artistic details.If you don’t want to spend on guided tours, you can also take the audio guides"
                },
                {
                    paraId: 5,
                    paraText: "<br /><h4>Travel Tips:</h4> Arrive little early to organise yourself, meet your guide (if you have opted for the guided tour) or even to attend your slot. Unfortunately, they wouldn’t refund you the money, if you have missed your slot."
                },
                {
                    paraId: 6,
                    paraText: "<br /><h4>Skip The Queue:</h4> As it is one of the most visited attractions in Barcelona, it is almost impossible to skip the queues. Here are the ways you can still try and avoid the tiring wait. (a) Buy the ticket in advance, book online (b) Buy tickets with Priority entrance (c) Book a guided tour (d) Take a private tour but be aware this may be expensive"
                },
                {
                    paraId: 7,
                    paraText: "<br /><h4>How To Get There:</h4> <ul><li>Metro – Is the easiest way to get around Barcelona. Both Purple Line L2 and Blue Line L5, have Sagrada Familia as stops</li>. <li>Hop on Hop off – Another way to travel around Barcelona is to buy the Hop on Hop off bus tickets, you can get to most of the tourist attractions through these busses. There is a specific stop for Sagrada Familia</li></ul>"
                },
                {
                    paraId: 8,
        ...
        },
        {
            ...
            blogParagraphs: [
                ...
                {
                    paraId: 2,
                    paraText: "<br />Balinese people cherishes legends and myths of the Indian Puranas and Hindu Epics. The epics Mahabharata and Ramayana has become enduring traditions among Indonesian believers, expressed through shadow puppet (wayang) and dance performances."
                },
                {
                    paraId: 3,
                    paraText: "<br />As Balinese people are so keen on art and culture, music and dance are integral part of their daily rituals. There are many famous dance forms, including Barong - the lion dance, Legong, an elaborate and intricate dance with swift complex hand movements and facial expressions and Kecak – the Ramayana monkey chant dance to name a few. I was very fortunate to witness Legong and Kechak and here is my account of what you can expect."
                },
                
                {
                    paraId: 4,
                    paraText: "<br /><h4>Legong at Puri Saren Royal Palace Ubud: </h4><br /><strong>Where:</strong> Two of the very famous Balinese dance performances, Legong and Barong are held everyday at the Royal palace in Ubud. <br /><br /><strong>Tickets:</strong> Tickets could be bought from the local sellers around the palace. When we went to the palace to enquire, I found that almost everyone in and around the palace is selling the tickets, and indeed they are all authentic tickets (I did confirm at the palace gates that they are authentic)."
                },
                {
                    paraId: 5,
                    paraText: "<br /><strong>When:</strong> The programme is held everyday in the evening at the palace grounds. \nIt starts with a performance from the Gamelan orchestra, which is the traditional Indonesian musical ensemble consisting mostly the percussion instruments. Some melodious tunes are played on the xylophone and flutes with occasional beats from Kendang (hand played drum) and gongs before a couple of beautifully dressed girls enter the stage. Heavily ornate with gold crowns, magnificent jewellery and highly embroidered dresses, they use swift hand and leg movements and vivid impressions to enact the dance drama. The ambience is gripping and you miss to notice that few mosquitoes have nested on your toes! I scratched a little and then immersed back deep into the drama. ‘Legong Kraton’ translates to ‘dance of the royal palace’ as in the past this was only performed within closed palace walls for the Royal family. Now though, it is performed at many places, incl. here in the Ubud Royal Palace. <br /><br /><strong>Travel Tips:</strong> Reach at least 30-40mins early to grab the best seats. The performance is held in the open palace grounds so, do carry some good bug spray to keep mosquitoes away."
                },
                {
                    paraId: 6,
                    paraText: "<br /><h4>Kecak Dance:</h4><br /> Kecak is performed on the story of one such Hindu epic ‘Ramayana’. Indonesia’s fascination towards Ramayana is not new — they have taken inspiration from both Sage Valmiki’s Ramayana and Tamil poet Kamban’s Ramayana and so it remains in the imagination and cultural milieu of the country. Kecak originated rom an old Balinese ritual called the Sanghyan. No musical instruments are used in this performance but instead a group of around 50, bare chested men, wearing black and white chequered sarong (wrap skirt) sits around a circle and repetitively chant 'Chak...Chak...Chak...' to create the background score for the dance drama. They do this in accordance to the emotion and milieu of the story. The story revolves around Lord Rama (the prince), his wife Sita and his brother Lakshman (also a young prince), who are in exile in the jungle and Ravana (the demon), who has casted an evil eye on Sita and plans to kidnap her. Garuda, who spots this tries to stop him while he is flying away with Sita in Pushpak Vimana (the flying chariot). The drama, the expressions, the performance of both Garuda and Ravana is outstanding and the scenes will leave you spell bound. You can’t help but notice getting emotionally involved deep into the tale. "
                },
                {
                    paraId: 7,
