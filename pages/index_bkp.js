...
const Home = (props)=> {
  ...
  props.blogList.blogListArr.forEach((b)=>{
    console.log(b);
  });
          ...
          <BodyContent>
            <TopContent>
              ...
              <ThemeSlider>
                ...
                <SliderImageWrapper>
                    <SwipeSlideImage imgSource="/images/slider/slider1.jpg"/>
                    <SwipeSlideImage imgSource="/images/slider/slider2.jpg"/>
                    <SwipeSlideImage imgSource="/images/slider/slider3.jpg"/>
                </SliderImageWrapper>
              </ThemeSlider>
            ...
            <FeaturCategoryWrapper>
                <FeatureCategoryItem 
                  imgSource="/images/category/asiaandafrica/asiaandafrica.jpg"
                  featureCategory="Travel & Advanture"
                  postCount="6"
                />
                <FeatureCategoryItem 
                  imgSource="/images/category/britain/britain.jpg"
                  featureCategory="Road Trips"
                  postCount="6"
                />
                <FeatureCategoryItem 
                  imgSource="/images/category/europe/europe.jpg"
                  featureCategory="Camping Trips"
                  postCount="6"
                />
                <FeatureCategoryItem 
                  imgSource="/images/category/usa/usa.jpg"
